...
status, output = subprocess.getstatusoutput('virtualenv .env')
print(output)

status, output = subprocess.getstatusoutput('.env/bin/pip install --upgrade setuptools')
print(output)

status, output = subprocess.getstatusoutput('.env/bin/pip install --upgrade pip')
print(output)

status, output = subprocess.getstatusoutput('.env/bin/pip install zc.buildout')
print(output)
...
status, output = subprocess.getstatusoutput('.env/bin/buildout bootstrap')
print(output)
